...
HC ist eine Premium-WebUI für **GPT Image / OpenAI-kompatible Image APIs**. Prompt, Referenzbilder, Ausgabeparameter, mehrere Kandidaten, Auswahl des besten Ergebnisses und weitere Iterationen aus diesem Bild laufen in einem fokussierten Workflow zusammen.
...
- Node.js: `pnpm build`, danach `pnpm start`.
