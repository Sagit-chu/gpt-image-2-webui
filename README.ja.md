...
HC は **GPT Image / OpenAI-compatible image API** のためのプレミアム WebUI です。プロンプト作成、参照画像アップロード、サイズと品質の調整、複数案の生成、ベスト画像の選択、選択結果からの再生成まで、1 つの流れで完結します。
...
- Node.js：`pnpm build` の後に `pnpm start`。
