...
HC 是一個面向設計師、品牌行銷、獨立開發者與 AI 圖片工作流團隊的 GPT 圖片生成 WebUI。它把 GPT Image / OpenAI-compatible image API 包裝成更順手的視覺化產品：撰寫 prompt、上傳參考圖、選擇尺寸與品質、批量出圖、挑選結果、繼續二創，一條鏈路完成。
...
<p align="center">
  <img src="./public/img_1.png" alt="HC 參數與預覽" width="100%">
</p>
...
- Node.js：執行 `pnpm build` 後使用 `pnpm start`。
